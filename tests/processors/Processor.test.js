...
describe('Processor', () => {
    ...
    describe('processInsertGetId', () => {
        test('should process INSERT and return ID', async () => {
            ...
            const id = await processor.processInsertGetId(mockBuilder, { name: 'Test' });
            expect(id).toBe(123);
        ...
        test('should handle sequence parameter', async () => {
            ...
            const id = await processor.processInsertGetId(mockBuilder, { name: 'Test' }, 'users_id_seq');
        ...
        test('should throw error if no connection', async () => {
            ...
            await expect(processor.processInsertGetId(mockBuilder, { name: 'Test' }))
                .rejects
                .toThrow('No database connection available');
        });
    });
    ...
    describe('processColumns', () => {
        test('should process column metadata', () => {
            ...
            expect(columns).toEqual([
                { name: 'id', type: 'integer', length: undefined, nullable: false, default: undefined },
                { name: 'name', type: 'string', length: undefined, nullable: true, default: undefined }
            ]);
        });
    ...
    describe('normalizeColumnType', () => {
        ...
        test('should normalize string types', () => {
            ...
            expect(processor.normalizeColumnType('character varying')).toBe('character varying');
        });
