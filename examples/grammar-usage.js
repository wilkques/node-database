...
export function example_update_with_calculation() {
  ...
  builder.from("user_scores").where("user_id", "=", 1);
...
export function example_delete_with_limit() {
  ...
  builder.from("logs").where("level", "=", "debug").limit(1000);
...
export function example_sqlite_limit() {
  ...
  builder.select(["*"]).from("users").orderBy("created_at", "desc");
...
export function runAllExamples() {
  ...
  console.log(
    "║  Grammar & Processors System - Comprehensive Examples         ║",
  );
  console.log(
    "╚════════════════════════════════════════════════════════════════╝",
  );
