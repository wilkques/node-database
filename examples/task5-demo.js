...
console.log(
  ...
  pgArrayValue,
  "→",
  pgProcessor.processValue(pgArrayValue, "varchar[]"),
);
...
console.log(
  ...
  pgJsonValue,
  "→",
  pgProcessor.processValue(pgJsonValue, "jsonb"),
);
...
console.log(
  ...
  pgUuidValue,
  "→",
  pgProcessor.processValue(pgUuidValue, "uuid"),
);

// PostgreSQL boolean
console.log(
  "PostgreSQL boolean (t):",
  "t",
  "→",
  pgProcessor.processValue("t", "boolean"),
);
console.log(
  "PostgreSQL boolean (f):",
  "f",
  "→",
  pgProcessor.processValue("f", "boolean"),
);

// PostgreSQL RETURNING clause
const pgReturningResult = pgGrammar.compileReturning({}, [
  "id",
  "name",
  "created_at",
]);
...
console.log(
  ...
  1,
  "→",
  sqliteProcessor.processValue(1, "boolean"),
);
console.log(
  "SQLite boolean (0):",
  0,
  "→",
  sqliteProcessor.processValue(0, "boolean"),
);
...
console.log(
  ...
  '"123"',
  "→",
  sqliteProcessor.processValue("123", "int"),
);
...
console.log(
  ...
  '"123.456"',
  "→",
  sqliteProcessor.processValue("123.456", "real"),
);
...
console.log(
  ...
  sqliteDateValue,
  "→",
  sqliteProcessor.processValue(sqliteDateValue, "datetime"),
);

// SQLite square bracket wrapping
console.log(
  "SQLite column wrapping:",
  "column_name",
  "→",
  sqliteGrammar.wrapValue("column_name"),
);
...
console.log(
  "SQLite LIMIT -1 OFFSET 10:",
  sqliteGrammar.compileLimit(mockQuery, null),
);
...
console.log(
  ...
  sqliteGrammar.dateFunction("date", "created_at"),
);
console.log(
  "SQLite STRFTIME function:",
  sqliteGrammar.dateFunction("strftime", "created_at", "%Y-%m-%d"),
);

// SQLite PRAGMA
console.log(
  "SQLite PRAGMA:",
  sqliteGrammar.compilePragma("journal_mode", "WAL"),
);
...
console.log("\n📊 Summary:");
console.log(
  "- PostgreSQL: RETURNING clauses, arrays, JSON/JSONB, UUID handling",
);
console.log(
  "- SQLite: Square brackets, LIMIT -1, boolean conversion, date functions",
);
console.log(
  "- Both: Enhanced value processing and database-specific optimizations",
);
