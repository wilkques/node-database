...
declare class Database {
     ...
     * @returns 查询构建器实例
     */
    static connect(driver: DatabaseConfig | string, host?: string, username?: string, password?: string, database?: string, port?: number, charset?: string): Promise<Builder>;
    /**
     * 创建查询构建器实例
     *
     ...
     * @returns 查询结果
     */
    static raw(config: DatabaseConfig, sql: string, bindings?: any[]): Promise<any>;
}
