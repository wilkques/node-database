...
export class Builder {
    ...
    whereSub(column, operator, callback, andOr = 'and') {
        ...
        [callback, operator] = this.prepareSubQueryArgs(operator, callback, arguments.length === 2);
     ...
     * @returns JoinBuilder for continued method chaining
     */
    joinSub(table, as, first, operator = '=', second, type = 'inner', isWhere = false) {
        const JoinBuilderClass = this._getJoinBuilderClass();
        if (!JoinBuilderClass) {
            // Fallback to basic implementation
        ...
        return joinBuilder.processSubqueryJoin(subqueryTable, first, operator, second || first, type, isWhere);
    }
    /**
    ...
    _getJoinBuilderClass() {
        try {
            return typeof globalThis !== 'undefined' && globalThis.JoinBuilderClass
                ? globalThis.JoinBuilderClass : null;
        }
        catch {
            return null;
        }
