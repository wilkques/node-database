...
declare class JoinBuilder extends Builder {
    ...
    constructor(connection: DatabaseConnection, table?: TableReference, type?: JoinType);
    /**
     ...
     * @returns JoinBuilder for method chaining
     */
    processSubqueryJoin(table: string, first: string, operator: string, second: string, type: JoinType, isWhere?: boolean): JoinBuilder;
    /**
