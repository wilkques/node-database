...
export default class SQLiteProcessor extends Processor {
    ...
    processColumnListing(results) {
        if (!results || !Array.isArray(results))
            return [];
        return results.map((row) => row.name || row.column_name || row.cid).filter(Boolean);
    }
    /**
...
//# sourceMappingURL=SQLiteProcessor.js.map