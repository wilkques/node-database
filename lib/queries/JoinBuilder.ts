...
class JoinBuilder extends Builder {
    ...
    constructor(connection: DatabaseConnection, table?: TableReference, type: JoinType = 'inner') {
        super(connection);
        if (table !== undefined) {
     ...
     */
    processJoin(table: TableReference, first: string, operator: string, second: string, type: JoinType): JoinBuilder {
     ...
     * @returns JoinBuilder for method chaining
     */
    handleCallbackJoin(table: string, callback: Function, type: JoinType): JoinBuilder {
     ...
     * @private
     */
    private validateJoinParameters(table?: TableReference, first?: string, operator?: string, second?: string): void {
    ...
    private resolveTable(): string | TableReference {
        ...
        if (this.joinTable && typeof this.joinTable === 'object' && (this.joinTable as RawExpression).raw === true) {
     ...
     * @private
     */
    private buildConditionsAndBindings(): { conditionSql: string; bindings: any[] } {
        const bindings: any[] = [];
        let conditionSql = '';
     ...
     * @private
     */
    private addJoinToBuilder(table: string | TableReference, conditionSql: string): void {
     ...
     */
    static left(connection: DatabaseConnection, table: TableReference): JoinBuilder {
     ...
     */
    static right(connection: DatabaseConnection, table: TableReference): JoinBuilder {
     ...
     */
    static inner(connection: DatabaseConnection, table: TableReference): JoinBuilder {
     ...
     */
    static full(connection: DatabaseConnection, table: TableReference): JoinBuilder {
