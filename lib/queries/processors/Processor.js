...
export default class Processor {
    ...
    processInsert(result) {
        return {
            ...
            affectedRows: result.affectedRows || result.rowCount || result.changes || 0,
            success: true
        };
    }
    ...
    async processInsertGetId(query, values, sequence = null) {
        ...
        // Get last insert ID
        let id = connection.getLastInsertId ?
    ...
    processColumns(fields = []) {
        ...
        return fields.map(field => {
            ...
            const nullableValue = field.nullable !== undefined ? field.nullable :
                                 (field.is_nullable !== undefined ? field.is_nullable :
                                  field.Null);

            const column = {
                name: field.name || field.column_name || field.Field,
                type: this.normalizeColumnType(field.type || field.data_type || field.Type),
            ...
            if (field.Key) column.key = field.Key;
            if (field.Extra) column.extra = field.Extra;
